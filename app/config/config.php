...
$app->set('flight.base_url', rtrim(dirname($_SERVER['SCRIPT_NAME']), '/') . '/',);           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
// $app->set('flight.base_url', '/directory/',);           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
...
return [
	...
	'database' => [
		...
		'dbname'   => 'TP_METIS',   // Database name (e.g., 'flightphp')
