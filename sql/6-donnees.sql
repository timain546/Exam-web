...
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (1, '2026-02-16', 5, 5000000, 5000000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (2, '2026-02-16', 5, 3000000, 3000000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (3, '2026-02-17', 5, 4000000, 4000000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (4, '2026-02-17', 5, 1500000, 1500000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (5, '2026-02-17', 5, 6000000, 6000000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (6, '2026-02-16', 1, 400, 400);

insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (7, '2026-02-16', 2, 600, 600);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (8, '2026-02-17', 3, 50, 50);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (9, '2026-02-17', 4, 70, 70);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (10, '2026-02-17', 9, 100, 100);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (11, '2026-02-18', 1, 2000, 2000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (12, '2026-02-18', 3, 300, 300);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (13, '2026-02-18', 2, 5000, 5000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (14, '2026-02-19', 5, 20000000, 20000000);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (15, '2026-02-19', 4, 500, 500);
insert into bngrc_dons (id_don, date_don, id_produit,quantite,quantite_restante) values (16, '2026-02-17', 9, 88, 88);
